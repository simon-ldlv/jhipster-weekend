...
import istic.weekend.config.audit.AuditEventConverter;
import istic.weekend.domain.PersistentAuditEvent;
...
import static istic.weekend.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
